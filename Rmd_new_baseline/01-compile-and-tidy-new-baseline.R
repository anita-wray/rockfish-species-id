...
source("R/rockfish-funcs-feather.R")


#### Call genos from the microhaplot feather files ####
...
fdf <- read.table("new_baseline_data/rds-file-list.txt", stringsAsFactors = FALSE, header = TRUE) %>%
  tbl_df()
dir <- "new_baseline_data/feather_files"
...
saveRDS(genos_long, file = "new_baseline_data/processed/called_genos.rds", compress = "xz")
