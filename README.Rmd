...
I'm going to mimic the NSF rockfish project and use the RDS genotype files, and then read them into this R project using the same code (or similar) as I did previously for my kelp rockfish.
