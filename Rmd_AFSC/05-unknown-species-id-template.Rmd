...
I feel very weird about these z-scores. I can't decide if it's a data artifact, something awry with the VCF file, batch effects (??) or actually just species that are not present in the baseline and are potentially different species.
...
ggsave("pdf_outputs/GOA_unknowns_w_unknownSpp.pdf")
```
